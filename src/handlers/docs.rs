...
#[openapi(
  ...
  components(
    schemas(
      ...
      crate::domain::criminal_case::PleaType,
      ...
      crate::domain::judge::ConflictType,
      ...
      crate::domain::order::ElectronicSignature,
      crate::domain::order::ServiceRecord,
      crate::domain::order::ServiceMethod,
      crate::domain::order::ServiceStatus,
      ...
      crate::domain::attorney::ConflictType,
      crate::domain::attorney::ConflictSeverity,
